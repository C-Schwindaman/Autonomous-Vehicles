...
print(f'Average Precision: {model.average_precision(test.labels, scores):.3f}')

# Plot classification results:
model.plot_results(test, scores, fignum='Result_1', block=False)
model.plot_hist(test.labels, scores, fignum='Hist_1', block=False)
model.plot_pr_curve(test.labels, scores, fignum="PR_Curve", block=True)
